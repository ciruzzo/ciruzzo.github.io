...
$M, m$それぞれの速度と衝突後の速度を$v, u$、$v’, u’$とし、
エネルギー保存の法則と、運動量保存の法則を解く。
...
$\begin{pmatrix} v' \\ u' \end{pmatrix} = \frac{1}{M+m} \begin{pmatrix} M-m & 2 m \\ - 2 M & M-m \end{pmatrix}\begin{pmatrix} v \\ u \end{pmatrix} $
