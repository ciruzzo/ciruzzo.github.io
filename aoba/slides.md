...
## 今日のゴール
- 「あ、これ知ってる」と思えること
- 困ったときに **まず何をすればいいか** が分かること
- 一人で抱え込まないで聞けるようになること
...
- 音量ボタンを押してみる
- イヤホンマークが出ていない？
- LINEやYouTubeだけ音が出ないこともあります

### 【やってみよう】
音量ボタンを押して、画面に出る表示を確認してみましょう。
...
- アプリをアプリの上に重ねる
- 自動で「フォルダ（箱）」ができます
- 名前を付けられます（例：買い物、交通、写真）

> ポイント：  
> 「これは使う」「これはたまに使う」で分けるだけでOK
