...
- 起動中アプリが増えすぎると、動きが悪くなる可能性。消し方は次の項目で
...
- パスキー
    ...
    - サービスへのログインにパスワードの代わりに画面ロックを用いる方法
    - 画面ロック：顔認証、指紋認証
...
- 自分のスマホに届いているメッセージやメールを、アプリを開いて確認してみましょう
  - 「メッセージ」：SMSのアプリ
  - 「メール」「Gmail」：メールのアプリ。自分のメールアドレスも確認
...
1. 画面の一番上を見てみましょう。
2. 扇形のマーク（Wi-Fi）は出ていますか？
3. 「4G」「5G」「LTE」と出ている人もいますか？
...
- **Android**：「設定」 ➔ 「Google」 ➔ 「自動入力」➔ 「Google パスワード マネージャー」
  - Chromeから調べる方法：Chrome ➔  「設定」 ➔ 「パスワード マネージャー」
